...
### n = num points in cell
  ## could do this for all taxa, if desired
if(nrow(Od) > 5000){
  #print("more than 5,000 coordinates; thinning")
  t <- gridSample(Od[,c("latitude","longitude")], Pro_areas, n=1,
                  chess='white'); t$flag = "keep"
  t2 <- full_join(Od,t)
  Od <- t2 %>% filter(flag=="keep") %>% select(-flag); rm(t,t2)
}
